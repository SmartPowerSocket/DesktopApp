...
enables an automatic setup without any input. Check app.js for further information.
...
* git clone https://github.com/danielmapar/ModifiedParticleCLI.git
* npm install
* node app.js // Remember to modify app.js to supply your needs
